...
6. Post-process the accepted output:
   ...
   - create or overwrite a final PNG version with an alpha channel
...
7. Return the final PNG image and the final PNG's absolute file path. Do not include prompt text, analysis, source notes, validation notes, or attempt counts.
